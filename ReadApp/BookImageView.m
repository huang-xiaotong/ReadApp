...
//@synthesize imageSizeName = _imageSizeName;
...
-(void)setImageURL:(NSString *)imageURL
{
    ...
    if(self.imageURL)
    {
        ...
        NSString *filename=[paths stringByAppendingPathComponent:@"BookImage"];
        ...
        self.fileName = [NSString stringWithFormat:@"%@/%@", filename, [lineArray objectAtIndex:[lineArray count] - 1]];
